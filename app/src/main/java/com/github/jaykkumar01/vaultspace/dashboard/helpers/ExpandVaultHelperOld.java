...
public class ExpandVaultHelperOld {
    ...
    private final TrustedAccountsDriveHelperOld driveHelper;
    ...
    public ExpandVaultHelperOld(AppCompatActivity activity, String primaryEmail) {
        this.activity = activity;
        this.primaryEmail = primaryEmail;

        driveHelper = new TrustedAccountsDriveHelperOld(activity.getApplicationContext(), primaryEmail);
    ...
    private void addTrustedAccount(String trustedEmail) {
        ...
        driveHelper.addTrustedAccountAsync(
                trustedEmail,
                new TrustedAccountsDriveHelperOld.AddResultCallback() {
